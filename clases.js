class Usuario {
    ...
    get vuelosComprados(){
      return this.vComprados
    }

    set vuelosComprados(nuevoVuelo){
        this.vComprados.push(nuevoVuelo);
...
//cuando sacamos un elemento del storage y lo parseamos lo convertiamos en un objeto pero perdíamos sus métodos.
    fromJsonToUsuarios(json){
        return Object.assign(this, json); // el assign nos devuelve un objeto de la propia clase.(en este caso de la clase usuario)
   }
}
