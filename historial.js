...
//Es un conjunto de compras de un mismo usuario.
function desplegarHistorial() {
    let comprasUsuario = userHistorial()

    comprasUsuario.forEach(element => { //recorremos compra a compra y recogemos sus datos para posteriormente ir pintándolos en la pantalla correspondiente.
